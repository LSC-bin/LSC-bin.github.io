(function (global) {
    ...
    const AppUtilsRef = global.AppUtils || {};
    const AuthServiceRef = global.AuthService || {};
    ...
    function initSidebar(rootElement, options = {}) {
        ...
        const handleResize = () => {
            ...
            raf(() => {
                ...
                const width = typeof global.innerWidth === 'number' ? global.innerWidth : Infinity;
                if (width > breakpoint) {
                    closeMobile();
                }
            });
        ...
        if (typeof global.addEventListener === 'function') {
            ...
            removeListeners.push(() => global.removeEventListener('resize', handleResize));
        }
    ...
    function getSidebarController(rootElement) {
        const root = rootElement || (global.document && (global.document.querySelector('.sidebar') || global.document.getElementById('sidebar')));
    ...
    global.SidebarModule = Object.assign({}, global.SidebarModule || {}, SidebarModule);
